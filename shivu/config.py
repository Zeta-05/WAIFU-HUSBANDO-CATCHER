class Config(object):
    ...
    TOKEN = "7774006210:AAEdO4XWeHabljjIg2Dm4ZQlWVgkgqqFJFQ"
    mongo_url = "mongodb+srv://vjimmy276:fCVmNKIqxQ0P54Co@ztx.pxamg.mongodb.net/?retryWrites=true&w=majority"
